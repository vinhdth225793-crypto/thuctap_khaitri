        ...
        <div class="col-md-8">
            <div class="d-flex align-items-center">
                ...
                <div>
                    ...
                    <div class="text-muted small mt-1">Cập nhật thông tin tài khoản và thông tin giảng dạy của bạn.</div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="card vip-card border-0 shadow-sm mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <h5 class="fw-bold mb-3 text-dark">
                            <i class="fas fa-chalkboard-teacher me-2 text-primary"></i>Thông tin giảng dạy
                        </h5>
                        <div class="row g-3">
                            <div class="col-md-4">
                                <label for="chuyen_nganh" class="form-label small fw-bold">Chuyên ngành</label>
                                <input type="text" name="chuyen_nganh" id="chuyen_nganh" class="form-control vip-form-control @error('chuyen_nganh') is-invalid @enderror" value="{{ old('chuyen_nganh', optional($user->giangVien)->chuyen_nganh) }}">
                                @error('chuyen_nganh')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4">
                                <label for="hoc_vi" class="form-label small fw-bold">Học vị</label>
                                <input type="text" name="hoc_vi" id="hoc_vi" class="form-control vip-form-control @error('hoc_vi') is-invalid @enderror" value="{{ old('hoc_vi', optional($user->giangVien)->hoc_vi) }}">
                                @error('hoc_vi')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-4">
                                <label for="so_gio_day" class="form-label small fw-bold">Số giờ dạy</label>
                                <input type="text" name="so_gio_day" id="so_gio_day" class="form-control vip-form-control @error('so_gio_day') is-invalid @enderror" value="{{ old('so_gio_day', optional($user->giangVien)->so_gio_day) }}" readonly>
                                @error('so_gio_day')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                ...
                <div class="d-grid gap-2">
                    ...
                    <a href="{{ route('giang-vien.dashboard') }}" class="btn btn-outline-secondary py-2 fw-bold">
                        HỦY BỎ
                    </a>
                </div>
            </div>
