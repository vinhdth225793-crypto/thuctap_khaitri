...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="{{ route('admin.tai-khoan.create') }}" class="btn btn-success">+ Thêm học viên</a>
    </div>
    ...
    <div class="card mb-4">
        <div class="card-body">
            <form method="GET" class="form-inline">
                ...
                <a href="{{ route('admin.hoc-vien.index') }}" class="btn btn-secondary mb-2 ml-2">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="8" class="text-center py-4">
                        <p class="text-muted mb-0">Không có học viên nào</p>
                    </td>
                </tr>
                @endforelse
            </tbody>
    ...
    <div class="d-flex justify-content-between align-items-center mt-4">
        <div class="text-muted">
            Tổng cộng: <strong>{{ $hocVien->total() }}</strong> học viên
        </div>
        {{ $hocVien->links() }}
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function() {
    const baseUrl = '{{ route("admin.hoc-vien.index") }}';
