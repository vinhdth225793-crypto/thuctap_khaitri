...
@section('title', 'Chỉnh sửa môn học: ' . $monHoc->ten_mon_hoc)
...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <h4 class="fw-bold"><i class="fas fa-edit me-2 text-warning"></i> Chỉnh sửa môn học</h4>
            <p class="text-muted small">Cập nhật thông tin chi tiết cho môn học <strong>{{ $monHoc->ten_mon_hoc }}</strong>.</p>
        </div>
    </div>

    <form action="{{ route('admin.mon-hoc.update', $monHoc->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            ...
            <div class="col-lg-8">
                <div class="vip-card mb-4 shadow-sm border-0">
                    ...
                    <div class="vip-card-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label class="form-label small fw-bold text-dark">Mã môn học (Chỉ đọc)</label>
                                <input type="text" class="form-control bg-light" value="{{ $monHoc->ma_mon_hoc }}" readonly>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="mo_ta" class="form-control vip-form-control @error('mo_ta') is-invalid @enderror" 
                                          rows="5" placeholder="Mô tả tóm tắt về môn học này...">{{ old('mo_ta', $monHoc->mo_ta) }}</textarea>
                            ...
                            <div class="col-12">
                                <div class="form-check form-switch mt-2">
                                    ...
                                    <input class="form-check-input" type="checkbox" name="trang_thai" id="trang_thai" value="1" {{ old('trang_thai', $monHoc->trang_thai) ? 'checked' : '' }}>
                                    <label class="form-check-label small fw-bold" for="trang_thai">Kích hoạt môn học</label>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="vip-card mb-4 shadow-sm border-0">
                    ...
                    <div class="vip-card-body p-4 text-center">
                        <div class="image-preview-wrapper mb-3 border rounded overflow-hidden bg-light d-flex align-items-center justify-content-center" style="height: 200px;">
                            <img id="preview-img" src="{{ $monHoc->hinh_anh ? asset($monHoc->hinh_anh) : asset('images/default-course.svg') }}" class="img-fluid" style="max-height: 100%;">
                        </div>
